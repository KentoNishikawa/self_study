...
// .wrangler/tmp/pages-e88Arg/functionsWorker-0.7920569242631037.mjs
...
__name2(readJsonRecord, "readJsonRecord");
...
__name2(isValidRegisterPassword, "isValidRegisterPassword");
function nowIso() {
...
__name2(addHoursIso, "addHoursIso");
function isFutureIso(value) {
  return Date.parse(value) > Date.now();
}
__name(isFutureIso, "isFutureIso");
__name2(isFutureIso, "isFutureIso");
...
__name2(createTokenPair, "createTokenPair");
...
__name2(createClearSessionCookie, "createClearSessionCookie");
...
__name2(getSessionTokenFromCookie, "getSessionTokenFromCookie");
...
__name2(findSession, "findSession");
...
__name2(sendAuthMail, "sendAuthMail");
...
__name2(buildVerificationMail, "buildVerificationMail");
...
__name2(buildPasswordResetMail, "buildPasswordResetMail");
...
__name2(textEncoder, "textEncoder");
...
__name2(findActiveAdminSession, "findActiveAdminSession");
...
__name2(createAdminLoginSession, "createAdminLoginSession");
...
__name2(revokeCurrentAdminSession, "revokeCurrentAdminSession");
...
__name2(createAdminSessionCookie, "createAdminSessionCookie");
...
__name2(createClearAdminSessionCookie, "createClearAdminSessionCookie");
...
__name2(getAdminSessionTokenFromCookie, "getAdminSessionTokenFromCookie");
...
__name2(createAdminId, "createAdminId");
...
__name2(getRouteParam, "getRouteParam");
...
__name2(redirectLocalAsset, "redirectLocalAsset");
...
__name(getRouteParam2, "getRouteParam2");
__name2(getRouteParam2, "getRouteParam");
function redirectLocalAsset2(request, imagePath) {
  if (!imagePath.startsWith("/")) return new Response("Not Found", { status: 404 });
  return Response.redirect(new URL(imagePath, request.url).toString(), 302);
}
__name(redirectLocalAsset2, "redirectLocalAsset2");
__name2(redirectLocalAsset2, "redirectLocalAsset");
...
__name2(maybeReadReplacementPreview, "maybeReadReplacementPreview");
...
__name2(renderAsset, "renderAsset");
function getRouteParam3(context, key) {
  const params = context.params;
  const value = params?.[key];
  return Array.isArray(value) ? value[0] ?? "" : value ?? "";
}
__name(getRouteParam3, "getRouteParam3");
__name2(getRouteParam3, "getRouteParam");
function redirectLocalAsset3(request, imagePath) {
  if (!imagePath.startsWith("/")) return new Response("Not Found", { status: 404 });
  return Response.redirect(new URL(imagePath, request.url).toString(), 302);
}
__name(redirectLocalAsset3, "redirectLocalAsset3");
__name2(redirectLocalAsset3, "redirectLocalAsset");
...
__name(maybeReadReplacementPreview2, "maybeReadReplacementPreview2");
__name2(maybeReadReplacementPreview2, "maybeReadReplacementPreview");
...
__name(renderAsset2, "renderAsset2");
__name2(renderAsset2, "renderAsset");
function getRouteParam4(context, key) {
  const params = context.params;
  const value = params?.[key];
  return Array.isArray(value) ? value[0] ?? "" : value ?? "";
}
__name(getRouteParam4, "getRouteParam4");
__name2(getRouteParam4, "getRouteParam");
function redirectLocalAsset4(request, imagePath) {
  if (!imagePath.startsWith("/")) return new Response("Not Found", { status: 404 });
  return Response.redirect(new URL(imagePath, request.url).toString(), 302);
}
__name(redirectLocalAsset4, "redirectLocalAsset4");
__name2(redirectLocalAsset4, "redirectLocalAsset");
...
__name2(validateLogin, "validateLogin");
...
__name2(readPlayerUserDetail, "readPlayerUserDetail");
...
__name2(readUserTitles, "readUserTitles");
...
__name2(readUserIcons, "readUserIcons");
...
__name2(readMatchHistory, "readMatchHistory");
...
__name2(readPlayerUserStatusLogs, "readPlayerUserStatusLogs");
...
__name2(updatePlayerUserStatus, "updatePlayerUserStatus");
...
__name2(toPlayerUserDetailResponse, "toPlayerUserDetailResponse");
...
__name2(toStatsSummary, "toStatsSummary");
...
__name2(playerRoleLabel, "playerRoleLabel");
...
__name(getRouteParam5, "getRouteParam5");
__name2(getRouteParam5, "getRouteParam");
...
__name2(userOwnsIcon, "userOwnsIcon");
...
__name2(userHasUnreadIconNotification, "userHasUnreadIconNotification");
function isAdminSession(session) {
  return session?.role === "admin" || session?.role === "owner";
}
__name(isAdminSession, "isAdminSession");
__name2(isAdminSession, "isAdminSession");
...
__name2(imageResponse, "imageResponse");
function getRouteParam6(context, key) {
  const params = context.params;
  const value = params?.[key];
  return Array.isArray(value) ? value[0] ?? "" : value ?? "";
}
__name(getRouteParam6, "getRouteParam6");
__name2(getRouteParam6, "getRouteParam");
function redirectLocalAsset5(request, imagePath) {
  if (!imagePath.startsWith("/")) return notFound();
  return Response.redirect(new URL(imagePath, request.url).toString(), 302);
}
__name(redirectLocalAsset5, "redirectLocalAsset5");
__name2(redirectLocalAsset5, "redirectLocalAsset");
function notFound() {
...
__name2(userViewedLoadingIllustration, "userViewedLoadingIllustration");
function isAdminSession2(session) {
  return session?.role === "admin" || session?.role === "owner";
}
__name(isAdminSession2, "isAdminSession2");
__name2(isAdminSession2, "isAdminSession");
...
__name(imageResponse2, "imageResponse2");
__name2(imageResponse2, "imageResponse");
function getRouteParam7(context, key) {
  const params = context.params;
  const value = params?.[key];
  return Array.isArray(value) ? value[0] ?? "" : value ?? "";
}
__name(getRouteParam7, "getRouteParam7");
__name2(getRouteParam7, "getRouteParam");
function redirectLocalAsset6(request, imagePath) {
  if (!imagePath.startsWith("/")) return notFound2();
  return Response.redirect(new URL(imagePath, request.url).toString(), 302);
}
__name(redirectLocalAsset6, "redirectLocalAsset6");
__name2(redirectLocalAsset6, "redirectLocalAsset");
function notFound2() {
  return new Response("Not Found", { status: 404 });
}
...
__name2(readAnnouncements, "readAnnouncements");
...
__name2(readAnnouncement, "readAnnouncement");
...
__name2(readAnnouncementInput, "readAnnouncementInput");
...
__name2(readCategory, "readCategory");
...
__name2(readPriority, "readPriority");
...
__name2(readNullableIso, "readNullableIso");
...
__name2(toAnnouncementResponse, "toAnnouncementResponse");
...
__name2(categoryLabel, "categoryLabel");
...
__name2(createIconReplaceChangeBatch, "createIconReplaceChangeBatch");
...
__name2(createLoadingIllustrationReplaceChangeBatch, "createLoadingIllustrationReplaceChangeBatch");
...
__name2(getOrCreateDraftBatchId, "getOrCreateDraftBatchId");
...
__name2(refreshDraftBatchMeta, "refreshDraftBatchMeta");
...
__name2(readCurrentDraftBatch, "readCurrentDraftBatch");
...
__name2(ensureSingleDraftBatch, "ensureSingleDraftBatch");
...
__name2(readBatchItems, "readBatchItems");
...
__name2(formatBatchDisplayNameFromItems, "formatBatchDisplayNameFromItems");
...
__name2(formatChangeItemDisplayName, "formatChangeItemDisplayName");
function readRecordText(record, key, fallback) {
  const value = record[key];
  return typeof value === "string" && value.trim() ? value.trim() : fallback;
}
__name(readRecordText, "readRecordText");
__name2(readRecordText, "readRecordText");
...
__name2(validateImageFile, "validateImageFile");
...
__name2(detectExtension, "detectExtension");
...
__name2(readAssetName, "readAssetName");
...
__name2(readAssetDescription, "readAssetDescription");
...
__name2(insertIconAsset, "insertIconAsset");
...
__name2(insertLoadingIllustrationAsset, "insertLoadingIllustrationAsset");
...
__name2(nextSortOrder, "nextSortOrder");
...
__name2(readIconAssets, "readIconAssets");
...
__name2(readLoadingIllustrationAssets, "readLoadingIllustrationAssets");
...
__name2(readIconReplaceTarget, "readIconReplaceTarget");
...
__name2(readLoadingIllustrationReplaceTarget, "readLoadingIllustrationReplaceTarget");
...
__name2(hasOpenIconChange, "hasOpenIconChange");
...
__name2(hasOpenLoadingIllustrationChange, "hasOpenLoadingIllustrationChange");
...
__name2(readIconEffect, "readIconEffect");
...
__name2(readLoadingIllustrationEffect, "readLoadingIllustrationEffect");
...
__name2(readOptionalReplaceAnnouncement, "readOptionalReplaceAnnouncement");
...
__name2(readOptionalLoadingIllustrationReplaceAnnouncement, "readOptionalLoadingIllustrationReplaceAnnouncement");
function readCategory2(value) {
  if (value === "normal" || value === "maintenance" || value === "bug" || value === "update" || value === "important") return value;
  return null;
}
__name(readCategory2, "readCategory2");
__name2(readCategory2, "readCategory");
function readPriority2(value) {
  const numberValue = Number(value);
  if (!Number.isFinite(numberValue)) return 0;
  return Math.trunc(numberValue);
}
__name(readPriority2, "readPriority2");
__name2(readPriority2, "readPriority");
...
__name(readNullableIso2, "readNullableIso2");
__name2(readNullableIso2, "readNullableIso");
...
__name2(toIconAssetResponse, "toIconAssetResponse");
...
__name2(toLoadingIllustrationAssetResponse, "toLoadingIllustrationAssetResponse");
...
__name2(readTitleIdFromParams, "readTitleIdFromParams");
...
__name2(normalizeCodePart, "normalizeCodePart");
...
__name2(createIconDeleteChangeBatch, "createIconDeleteChangeBatch");
...
__name2(createLoadingIllustrationDeleteChangeBatch, "createLoadingIllustrationDeleteChangeBatch");
...
__name2(createTitleIconRewardsChangeBatch, "createTitleIconRewardsChangeBatch");
...
__name2(appendIconDeleteApplyStatements, "appendIconDeleteApplyStatements");
...
__name2(appendIconReplaceApplyStatements, "appendIconReplaceApplyStatements");
...
__name2(appendLoadingIllustrationDeleteApplyStatements, "appendLoadingIllustrationDeleteApplyStatements");
...
__name2(appendLoadingIllustrationReplaceApplyStatements, "appendLoadingIllustrationReplaceApplyStatements");
...
__name2(appendTitleIconRewardsApplyStatements, "appendTitleIconRewardsApplyStatements");
...
__name2(cancelBatch, "cancelBatch");
...
__name2(cancelChangeItem, "cancelChangeItem");
...
__name2(appendAnnouncementStatements, "appendAnnouncementStatements");
...
__name2(readBatches, "readBatches");
...
__name(readBatchItems2, "readBatchItems2");
__name2(readBatchItems2, "readBatchItems");
...
__name2(readLoadingIllustration, "readLoadingIllustration");
...
__name(hasOpenIconChange2, "hasOpenIconChange2");
__name2(hasOpenIconChange2, "hasOpenIconChange");
...
__name2(hasOpenIconDelete, "hasOpenIconDelete");
...
__name(hasOpenLoadingIllustrationChange2, "hasOpenLoadingIllustrationChange2");
__name2(hasOpenLoadingIllustrationChange2, "hasOpenLoadingIllustrationChange");
...
__name2(readTitleIconRewardIds, "readTitleIconRewardIds");
...
__name2(validateIconRewardIds, "validateIconRewardIds");
...
__name2(readIconSummaries, "readIconSummaries");
...
__name2(hasOpenTitleIconRewardsChange, "hasOpenTitleIconRewardsChange");
...
__name2(readTitleIconRewardsEffect, "readTitleIconRewardsEffect");
...
__name2(readTitleUsersMissingIcon, "readTitleUsersMissingIcon");
...
__name2(readIconDeleteEffect, "readIconDeleteEffect");
...
__name(readLoadingIllustrationEffect2, "readLoadingIllustrationEffect2");
__name2(readLoadingIllustrationEffect2, "readLoadingIllustrationEffect");
...
__name2(readOptionalAnnouncement, "readOptionalAnnouncement");
function readCategory3(value) {
  if (value === "normal" || value === "maintenance" || value === "bug" || value === "update" || value === "important") return value;
  return null;
}
__name(readCategory3, "readCategory3");
__name2(readCategory3, "readCategory");
function readPriority3(value) {
  const numberValue = typeof value === "number" ? value : Number(getString(value));
  if (!Number.isFinite(numberValue)) return 0;
  return Math.trunc(numberValue);
}
__name(readPriority3, "readPriority3");
__name2(readPriority3, "readPriority");
...
__name(readNullableIso3, "readNullableIso3");
__name2(readNullableIso3, "readNullableIso");
...
__name(getOrCreateDraftBatchId2, "getOrCreateDraftBatchId2");
__name2(getOrCreateDraftBatchId2, "getOrCreateDraftBatchId");
async function refreshDraftBatchMeta2(env, batchId, now) {
  const items = await readBatchItems2(env, batchId);
  const batchName = formatBatchDisplayNameFromItems2(items) || "\u6B21\u56DE\u53CD\u6620\u4E88\u5B9A";
  await env.DB.prepare("UPDATE admin_change_batches SET batch_name = ?, updated_at = ? WHERE batch_id = ? AND status = 'draft'").bind(batchName, now, batchId).run();
}
__name(refreshDraftBatchMeta2, "refreshDraftBatchMeta2");
__name2(refreshDraftBatchMeta2, "refreshDraftBatchMeta");
...
__name(readCurrentDraftBatch2, "readCurrentDraftBatch2");
__name2(readCurrentDraftBatch2, "readCurrentDraftBatch");
...
__name2(formatBatchDisplayName, "formatBatchDisplayName");
...
__name(formatBatchDisplayNameFromItems2, "formatBatchDisplayNameFromItems2");
__name2(formatBatchDisplayNameFromItems2, "formatBatchDisplayNameFromItems");
...
__name(formatChangeItemDisplayName2, "formatChangeItemDisplayName2");
__name2(formatChangeItemDisplayName2, "formatChangeItemDisplayName");
function readRecordText2(record, key, fallback) {
  const value = record[key];
  return typeof value === "string" && value.trim() ? value.trim() : fallback;
}
__name(readRecordText2, "readRecordText2");
__name2(readRecordText2, "readRecordText");
...
__name2(countMainChangeItems, "countMainChangeItems");
...
__name2(toBatchResponse, "toBatchResponse");
...
__name2(toItemResponse, "toItemResponse");
...
__name2(toAdminActor, "toAdminActor");
function truncateText(value, maxLength) {
  return value.length > maxLength ? value.slice(0, maxLength) : value;
}
__name(truncateText, "truncateText");
__name2(truncateText, "truncateText");
...
__name(parseJson6, "parseJson6");
__name2(parseJson6, "parseJson");
...
__name2(batchStatements, "batchStatements");
...
__name2(readLoadingIllustrationInput, "readLoadingIllustrationInput");
function readAppearanceMode(value) {
  if (value === "auto" || value === "manual") return value;
  return null;
}
__name(readAppearanceMode, "readAppearanceMode");
__name2(readAppearanceMode, "readAppearanceMode");
...
__name2(readTitleName, "readTitleName");
...
__name2(updateLoadingIllustration, "updateLoadingIllustration");
var AdminInputError = class extends Error {
  static {
    __name(this, "AdminInputError");
  }
  static {
    __name2(this, "AdminInputError");
  }
};
...
__name2(readTargetType, "readTargetType");
...
__name2(readTitleInput, "readTitleInput");
...
__name2(readIconInput, "readIconInput");
...
__name2(normalizeJsonText, "normalizeJsonText");
function readFlag2(value) {
  return value === true || value === 1 || value === "1" ? 1 : 0;
}
__name(readFlag2, "readFlag2");
__name2(readFlag2, "readFlag");
...
__name(readIconRewardIds2, "readIconRewardIds2");
__name2(readIconRewardIds2, "readIconRewardIds");
function readInteger(value, fallback) {
  const numberValue = Number(value);
  return Number.isSafeInteger(numberValue) ? numberValue : fallback;
}
__name(readInteger, "readInteger");
__name2(readInteger, "readInteger");
...
__name2(readTitleIconRewards, "readTitleIconRewards");
...
__name(readTitle2, "readTitle2");
__name2(readTitle2, "readTitle");
...
__name(readTitleIconRewardIds2, "readTitleIconRewardIds2");
__name2(readTitleIconRewardIds2, "readTitleIconRewardIds");
...
__name2(createTitleIconRewardsChangeBatchIfNeeded, "createTitleIconRewardsChangeBatchIfNeeded");
...
__name(getOrCreateDraftBatchId3, "getOrCreateDraftBatchId3");
__name2(getOrCreateDraftBatchId3, "getOrCreateDraftBatchId");
...
__name(refreshDraftBatchMeta3, "refreshDraftBatchMeta3");
__name2(refreshDraftBatchMeta3, "refreshDraftBatchMeta");
...
__name(readCurrentDraftBatch3, "readCurrentDraftBatch3");
__name2(readCurrentDraftBatch3, "readCurrentDraftBatch");
...
__name(ensureSingleDraftBatch3, "ensureSingleDraftBatch3");
__name2(ensureSingleDraftBatch3, "ensureSingleDraftBatch");
...
__name(readBatchItems3, "readBatchItems3");
__name2(readBatchItems3, "readBatchItems");
...
__name(formatBatchDisplayNameFromItems3, "formatBatchDisplayNameFromItems3");
__name2(formatBatchDisplayNameFromItems3, "formatBatchDisplayNameFromItems");
...
__name(formatChangeItemDisplayName3, "formatChangeItemDisplayName3");
__name2(formatChangeItemDisplayName3, "formatChangeItemDisplayName");
function readRecordText3(record, key, fallback) {
  const value = record[key];
  return typeof value === "string" && value.trim() ? value.trim() : fallback;
}
__name(readRecordText3, "readRecordText3");
__name2(readRecordText3, "readRecordText");
...
__name(parseJson7, "parseJson7");
__name2(parseJson7, "parseJson");
...
__name(validateIconRewardIds2, "validateIconRewardIds2");
__name2(validateIconRewardIds2, "validateIconRewardIds");
...
__name(readIconSummaries2, "readIconSummaries2");
__name2(readIconSummaries2, "readIconSummaries");
...
__name(hasOpenIconDelete2, "hasOpenIconDelete2");
__name2(hasOpenIconDelete2, "hasOpenIconDelete");
...
__name(hasOpenTitleIconRewardsChange2, "hasOpenTitleIconRewardsChange2");
__name2(hasOpenTitleIconRewardsChange2, "hasOpenTitleIconRewardsChange");
...
__name(readTitleIconRewardsEffect2, "readTitleIconRewardsEffect2");
__name2(readTitleIconRewardsEffect2, "readTitleIconRewardsEffect");
function isSameIdList2(left, right) {
  if (left.length !== right.length) return false;
  return left.every((value, index) => value === right[index]);
}
__name(isSameIdList2, "isSameIdList2");
__name2(isSameIdList2, "isSameIdList");
...
__name2(insertTitle, "insertTitle");
...
__name2(updateTitle, "updateTitle");
...
__name2(toTitleResponse, "toTitleResponse");
...
__name2(toIconResponse, "toIconResponse");
...
__name2(toSaveErrorMessage, "toSaveErrorMessage");
var PAGE_SIZE = 50;
...
__name2(countPlayerUsers, "countPlayerUsers");
...
__name2(readPlayerUsers, "readPlayerUsers");
...
__name2(toPlayerUserResponse, "toPlayerUserResponse");
function playerRoleLabel2(role) {
  if (role === "owner") return "\u7BA1\u7406\u8CAC\u4EFB\u8005";
  if (role === "admin") return "\u7BA1\u7406\u8005";
  return "\u901A\u5E38\u30E6\u30FC\u30B6\u30FC";
}
__name(playerRoleLabel2, "playerRoleLabel2");
__name2(playerRoleLabel2, "playerRoleLabel");
...
__name2(updateDisplayName, "updateDisplayName");
...
__name2(updateStatus, "updateStatus");
...
__name2(deleteAdmin, "deleteAdmin");
...
__name2(readAdminTarget, "readAdminTarget");
...
__name2(toUserResponse, "toUserResponse");
...
__name(validateLogin2, "validateLogin2");
__name2(validateLogin2, "validateLogin");
...
__name2(validatePasswordReset, "validatePasswordReset");
...
__name2(validatePasswordResetRequest, "validatePasswordResetRequest");
...
__name2(validateRegister, "validateRegister");
...
__name2(readActiveAnnouncements, "readActiveAnnouncements");
...
__name(toAnnouncementResponse2, "toAnnouncementResponse2");
__name2(toAnnouncementResponse2, "toAnnouncementResponse");
...
__name(categoryLabel2, "categoryLabel2");
__name2(categoryLabel2, "categoryLabel");
...
__name2(getFormString, "getFormString");
...
__name2(fileToBase64, "fileToBase64");
...
__name2(buildTextEmail, "buildTextEmail");
...
__name2(buildHtmlEmail, "buildHtmlEmail");
...
__name2(buildHtmlRow, "buildHtmlRow");
...
__name2(formatJstDate, "formatJstDate");
...
__name2(ensureCollectionSeed, "ensureCollectionSeed");
...
__name2(grantInitialTitlesFromDb, "grantInitialTitlesFromDb");
...
__name2(grantInitialIconsFromDb, "grantInitialIconsFromDb");
...
__name2(readTitleCollection, "readTitleCollection");
...
__name2(readIconCollection, "readIconCollection");
...
__name2(readIllustrationCollection, "readIllustrationCollection");
...
__name(toTitleResponse2, "toTitleResponse2");
__name2(toTitleResponse2, "toTitleResponse");
...
__name(toIconResponse2, "toIconResponse2");
__name2(toIconResponse2, "toIconResponse");
...
__name2(toIllustrationResponse, "toIllustrationResponse");
...
__name2(createInitialTitleSeed, "createInitialTitleSeed");
...
__name2(createIconSeed, "createIconSeed");
...
__name2(toRarityStars, "toRarityStars");
...
__name2(toEpochMillis, "toEpochMillis");
...
__name2(formatAcquiredAt, "formatAcquiredAt");
...
__name2(toLoadingIllustrationImagePath, "toLoadingIllustrationImagePath");
...
__name2(pickLoadingIllustration, "pickLoadingIllustration");
...
__name2(readLoadingIllustrations, "readLoadingIllustrations");
...
__name(readUserTitles2, "readUserTitles2");
__name2(readUserTitles2, "readUserTitles");
...
__name2(isLoadingIllustrationEligible, "isLoadingIllustrationEligible");
...
__name2(parseConditionParams, "parseConditionParams");
...
__name2(normalizeStringValues, "normalizeStringValues");
...
__name2(pickByAppearanceSettings, "pickByAppearanceSettings");
...
__name2(viewStateGroupWeight, "viewStateGroupWeight");
...
__name2(pickWithinViewState, "pickWithinViewState");
function pickRandomItem(items) {
  if (items.length <= 0) return null;
  return items[Math.floor(Math.random() * items.length)] ?? null;
}
__name(pickRandomItem, "pickRandomItem");
__name2(pickRandomItem, "pickRandomItem");
...
__name2(pickWeightedManualItem, "pickWeightedManualItem");
...
__name2(manualRate, "manualRate");
function readAppearanceMode2(item) {
  return item.appearance_mode === "manual" ? "manual" : "auto";
}
__name(readAppearanceMode2, "readAppearanceMode2");
__name2(readAppearanceMode2, "readAppearanceMode");
...
__name2(recordLoadingIllustrationView, "recordLoadingIllustrationView");
...
__name2(evaluateCondition, "evaluateCondition");
...
__name(parseConditionParams2, "parseConditionParams2");
__name2(parseConditionParams2, "parseConditionParams");
...
__name2(readStatValue, "readStatValue");
...
__name2(evaluateStatValueAtLeast, "evaluateStatValueAtLeast");
...
__name2(evaluateStatValueAtMost, "evaluateStatValueAtMost");
...
__name2(evaluateStatFlagTrue, "evaluateStatFlagTrue");
...
__name2(evaluateStatJsonContainsAll, "evaluateStatJsonContainsAll");
...
__name2(evaluateStatJsonContainsKey, "evaluateStatJsonContainsKey");
...
__name2(evaluateMatchAchievementKey, "evaluateMatchAchievementKey");
...
__name2(evaluateAllConditions, "evaluateAllConditions");
...
__name2(evaluateAnyCondition, "evaluateAnyCondition");
...
__name2(readNumericStatValue, "readNumericStatValue");
...
__name2(readTotalStatValue, "readTotalStatValue");
...
__name2(getStatsRow, "getStatsRow");
...
__name2(readStatRequest, "readStatRequest");
...
__name2(readNestedConditions, "readNestedConditions");
...
__name2(normalizeConditionType, "normalizeConditionType");
...
__name2(normalizeParamsObject, "normalizeParamsObject");
...
__name2(readStringParam, "readStringParam");
...
__name2(readNumberParam, "readNumberParam");
...
__name2(readStringArrayParam, "readStringArrayParam");
...
__name2(readJsonStringSet, "readJsonStringSet");
...
__name2(parseJsonValue, "parseJsonValue");
...
__name2(readNumericValue, "readNumericValue");
...
__name2(createAcquiredNotification, "createAcquiredNotification");
...
__name2(readUnreadNotifications, "readUnreadNotifications");
...
__name2(markNotificationsRead, "markNotificationsRead");
...
__name2(toNotificationResponse, "toNotificationResponse");
...
__name2(toTitleAwardNotification, "toTitleAwardNotification");
...
__name2(toIconAwardNotification, "toIconAwardNotification");
...
__name2(toIconNotificationImagePath, "toIconNotificationImagePath");
...
__name2(toTitleIllustrationAwardNotification, "toTitleIllustrationAwardNotification");
...
__name2(normalizeNotificationIds, "normalizeNotificationIds");
function toRarityStars2(rarity) {
  const level = Math.min(5, Math.max(1, Math.round(Number(rarity) || 1)));
  return "\u2606".repeat(level);
}
__name(toRarityStars2, "toRarityStars2");
__name2(toRarityStars2, "toRarityStars");
...
__name2(grantAutomaticAcquisitions, "grantAutomaticAcquisitions");
...
__name2(buildConditionContext, "buildConditionContext");
...
__name2(readStatsRow, "readStatsRow");
...
__name2(grantAutomaticTitles, "grantAutomaticTitles");
...
__name2(grantAutomaticIcons, "grantAutomaticIcons");
...
__name2(grantTitleRewardIcons, "grantTitleRewardIcons");
...
__name2(grantIconIfMissing, "grantIconIfMissing");
...
__name2(readTitleRewardIconIds, "readTitleRewardIconIds");
function uniqueIds(ids) {
  return Array.from(new Set(ids));
}
__name(uniqueIds, "uniqueIds");
__name2(uniqueIds, "uniqueIds");
...
__name2(readTitleCandidates, "readTitleCandidates");
...
__name2(readIconCandidates, "readIconCandidates");
...
__name2(normalizeMatchPayload, "normalizeMatchPayload");
...
__name2(normalizeParticipants, "normalizeParticipants");
...
__name2(normalizeHumanStats, "normalizeHumanStats");
...
__name2(createMatchStats, "createMatchStats");
...
__name2(ensureUserStats, "ensureUserStats");
...
__name2(updateModeStats, "updateModeStats");
...
__name2(updateGlobalStats, "updateGlobalStats");
...
__name2(updateStatsRow, "updateStatsRow");
...
__name2(getStatsModeTable, "getStatsModeTable");
...
__name2(normalizeRankCounts, "normalizeRankCounts");
...
__name2(normalizeStatsGameTypeKey, "normalizeStatsGameTypeKey");
...
__name2(mergeJsonStringSet, "mergeJsonStringSet");
...
__name2(readJsonStringArray, "readJsonStringArray");
...
__name2(normalizeParticipantType, "normalizeParticipantType");
function normalizeEnum(value, allowed) {
  if (typeof value !== "string") return null;
  return allowed.has(value) ? value : null;
}
__name(normalizeEnum, "normalizeEnum");
__name2(normalizeEnum, "normalizeEnum");
...
__name2(normalizeNullableText, "normalizeNullableText");
...
__name2(normalizeIso, "normalizeIso");
...
__name2(normalizeInteger, "normalizeInteger");
...
__name2(normalizeParticipantNoOrNull, "normalizeParticipantNoOrNull");
function normalizeFlag(value) {
  return value === true || value === 1 || value === "1" ? 1 : 0;
}
__name(normalizeFlag, "normalizeFlag");
__name2(normalizeFlag, "normalizeFlag");
...
__name2(normalizeExistingNullableNumber, "normalizeExistingNullableNumber");
function readNumber3(value) {
  const normalized = normalizeExistingNullableNumber(value);
  return normalized ?? 0;
}
__name(readNumber3, "readNumber3");
__name2(readNumber3, "readNumber");
...
__name2(readModeStats, "readModeStats");
...
__name2(readGlobalStats, "readGlobalStats");
...
__name2(readWinStreaks, "readWinStreaks");
...
__name2(readRecentMatches, "readRecentMatches");
...
__name2(readParticipants, "readParticipants");
...
__name2(normalizeModeStats, "normalizeModeStats");
...
__name2(sumModeStats, "sumModeStats");
...
__name2(withWinStreaks, "withWinStreaks");
...
__name2(normalizeGlobalStats, "normalizeGlobalStats");
function readNumber4(value) {
  const numberValue = Number(value ?? 0);
  if (!Number.isFinite(numberValue)) return 0;
  return Math.trunc(numberValue);
}
__name(readNumber4, "readNumber4");
__name2(readNumber4, "readNumber");
...
__name2(readNullableNumber, "readNullableNumber");
function readFlag3(value) {
  return readNumber4(value) === 1;
}
__name(readFlag3, "readFlag3");
__name2(readFlag3, "readFlag");
...
__name2(ensureUserSettings, "ensureUserSettings");
...
__name2(readSettingsPatch, "readSettingsPatch");
...
__name2(validateSettingsPatch, "validateSettingsPatch");
...
__name2(toResponseSettings, "toResponseSettings");
function getNullableString(value) {
  if (value === null) return null;
  return typeof value === "string" ? value : null;
}
__name(getNullableString, "getNullableString");
__name2(getNullableString, "getNullableString");
...
__name2(normalizeDisplayName, "normalizeDisplayName");
function normalizeNullableText2(value) {
  const normalized = String(value ?? "").trim();
  return normalized || null;
}
__name(normalizeNullableText2, "normalizeNullableText2");
__name2(normalizeNullableText2, "normalizeNullableText");
...
__name2(normalizeSoundVolumeLevel, "normalizeSoundVolumeLevel");
var routes = [
  {
...
// .wrangler/tmp/bundle-K1AltI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-K1AltI/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7920569242631037.js.map
